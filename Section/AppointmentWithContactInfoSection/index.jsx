...
const contactInfo = [
  { title: 'Phone', subTitle: '(02) 847-4747' },
  { title: 'Email Us', subTitle: 'gsiscares@gsis.gov.ph' },
  { title: 'Our Location', subTitle: 'Jose W. Diokno Boulevard, Pasay City, 1308 Metro Manila, Philippines' },
];
    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-lg-4 offset-lg-1">
          ...
          <img
            src="/images/appointments/appointment_img.png"
            alt="Appointment"
